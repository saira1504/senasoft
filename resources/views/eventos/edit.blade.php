...
@section('title', 'Editar Evento - Sistema de Gestión')
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">
                    <i class="fas fa-edit me-2"></i>Editar Evento: {{ $evento->nombre_evento }}
                </h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre_evento') is-invalid @enderror" 
                                   id="nombre_evento" name="nombre_evento" value="{{ old('nombre_evento', $evento->nombre_evento) }}" required>
                            @error('nombre_evento')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('municipio') is-invalid @enderror" 
                                   id="municipio" name="municipio" value="{{ old('municipio', $evento->municipio) }}" required>
                            @error('municipio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('departamento') is-invalid @enderror" 
                                   id="departamento" name="departamento" value="{{ old('departamento', $evento->departamento) }}" required>
                            @error('departamento')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('fecha_hora_inicio') is-invalid @enderror" 
                                   ...
                                   value="{{ old('fecha_hora_inicio', $evento->fecha_hora_inicio->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('fecha_hora_fin') is-invalid @enderror" 
                                   ...
                                   value="{{ old('fecha_hora_fin', $evento->fecha_hora_fin->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="artistas[]" 
                                           ...
                                           {{ in_array($artista->id, old('artistas', $evento->artistas->pluck('id')->toArray())) ? 'checked' : '' }}>

...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="gradient-text mb-2"><i class="fas fa-ticket-alt me-2"></i>Gestión de Boletas</h2>
                <p class="text-muted">Controla precios, disponibilidad y tipos de boletas</p>
            </div>
            <a href="{{ route('boletas.create') }}" class="btn btn-primary pulse-animation">

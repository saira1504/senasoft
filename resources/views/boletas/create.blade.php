                ...
                <form action="{{ route('boletas.store') }}" method="POST">
                    ...
                    @if($eventos->count() == 0 || $localidades->count() == 0)
                        <div class="alert alert-warning">
                            ...
                            @if($eventos->count() == 0)
                                No hay eventos disponibles. <a href="{{ route('eventos.create') }}">Crear un evento</a> primero.
                            @endif
                            @if($localidades->count() == 0)
                                No hay localidades disponibles. <a href="{{ route('localidades.create') }}">Crear una localidad</a> primero.
                            @endif
                        </div>
                    @endif
